...
export class page extends outlook.baby<crud_result> {
    ...
    private get_admin_parameters(button: HTMLButtonElement): admin_parameters {
        ...
        const subject: schema.subject = {ename: col.ref.table_name, dbname: col.ref.db_name};
        //
    ...
    private * collect_questions() {
        ...
        for(let td of tds) {
            ...
            const label: quest.label =[this.subject.dbname, this.subject.ename, alias, cname, exp];
            //
    ...
    public async merge():Promise<void>{
        ...
        //
        // get the database name from the subject
        const {dbname,ename} = this.subject;
        //
